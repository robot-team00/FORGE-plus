...
\author{The FORGE-plus project\thanks{Code, checkpoints, evaluation logs, and videos: \url{https://github.com/robot-team00/FORGE-plus}. This is a simulation-only study; no real-robot experiments are reported or implied.}}
...
\subsection{Task 3: fragile bottle, jam caught at 16.1\,N against a 23\,N break}
\label{sec:exp-task3}
...
\textbf{Disturbances are injected and simple.} The 5\,mm slip and the rim wedge are controllable, reproducible faults --- not a naturalistic failure distribution. Richer jams (angular catch, burrs, cross-threading) are future work, as is Task 2 (multi-step assembly) from the original proposal.
